                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="{{Active::checkRoute('nfc_card')}}"><a href="{{route('nfc_card')}}"></i><i
                                        class="fas fa-id-card" aria-hidden="true"></i>
                                    Register New Card</a></li>

                                    <li class="{{Active::checkRoute('cardScan')}}"><a href="{{route('cardScan')}}"></i><i
                                        class="fas fa-eye" aria-hidden="true"></i>
                                    View Patient History</a></li>
