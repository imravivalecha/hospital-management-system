...
// NFC
Route::get('/nfc-card', ['as' => 'nfc_card', 'uses' => 'NfcCardsController@index'])->middleware('auth', 'staff', 'lang');
Route::post('/nfc-card', ['as' => 'register_card', 'uses' => 'NfcCardsController@store'])->middleware('auth', 'staff', 'lang');
...
Route::get('/patient-history', ['as' => 'cardScan', 'uses' => 'PatientController@patientHistoryIndex'])->middleware('auth', 'doctor', 'lang');
Route::post('/patient-history', ['as' => 'view_patient_history_by_card', 'uses' => 'PatientController@cardPatientHistory'])->middleware('auth', 'doctor', 'lang');
